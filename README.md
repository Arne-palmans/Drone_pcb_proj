<h1>ESP-32 DRONE</h1>
<HR>
<img width="750" height="500" alt="image" src="https://github.com/user-attachments/assets/4daa8505-7ef7-4dcc-8fc7-591f1e4af7ed" />
<p></p>
<p></p>
I have had a great interest in building drones since I was young. However, I only recently started to turn it into a real hobby. As soon as we heard that we were going to build a PCB project ourselves, I was quickly convinced of what I wanted to design. 
In todays world drones have rapidly evolved to become an adaptable tool being used in a wide range of sectors ranging from photography to agriculture or even for playing a major role in national military defense.
To this end, I did some research into drone building to see if I could create something compact and simple that still has a big impact. Ultimately, I settled on a project by Jobit Joseph: a printed circuit board that is compact and small, and easy to assemble after having the design printed.
<p></p>
...
Inspiration from:
<br>
https://github.com/Circuit-Digest/ESP-Drone/tree/main?tab=readme-ov-file
